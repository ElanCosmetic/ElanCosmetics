...
const OrderDialogDesktop = ({ order, selectedOrder, setSelectedOrder }: Props) => {
    ...
    return (
        <Dialog>
            ...
            {selectedOrder && selectedOrder.orderNumber === order.orderNumber && (
                // DESKTOP VERSION
                <DialogContent className="max-w-lg sm:max-w-lg w-full text-gray-700">
                    <DialogHeader>
                            ...
                            return (
                                <div key={index} className="bg-white p-2 rounded-lg shadow-md grid grid-cols-[auto_1fr] text-sm">
                                    ...
                                    <div className="flex flex-col gap-2" >
                                        <div className="flex items-baseline gap-2 line-clamp-2">
...
export default OrderDialogDesktop;